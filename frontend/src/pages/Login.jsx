...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (!hasCompletedPlacement) {
        ...
        // Jika user lama yang sudah punya data kurikulum adaptif, langsung ke Dashboard
        navigate("/dashboard");
      }
    } catch (error) {
      console.error("Error Login:", error);
      // Tangkap pesan kegagalan kustom dari Express Controller
      const errorMessage =
  ...
  const handleEmailVerifySubmit = (e) => {
    ...
    // TODO: Jika tim sempat, sambungkan ke endpoint forgot password kustom kalian di minggu ini
    setModalStep(2);
  };
  ...
  const handleResetPasswordSubmit = (e) => {
    ...
    // TODO: Jika tim sempat, sambungkan ke endpoint reset password kustom kalian di minggu ini
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <input type="checkbox" style={{ cursor: "pointer" }} /> Remember
                me
              </label>
            ...
            <button
              ...
              style={{
                width: "100%",
                padding: "14px",
                backgroundColor: isLoading ? "#a0bceb" : "#3b71ca",
                color: "#fff",
                border: "none",
                borderRadius: "12px",
                fontWeight: "bold",
          ...
          <div style={{ display: "flex", gap: "15px" }}>
            <button
              onClick={() =>
                alert(
                  "Fitur OAuth disembunyikan untuk fokus pada demo input manual.",
                )
              }
              type="button"
              style={{
          ...
          >
              ...
              <form onSubmit={handleEmailVerifySubmit}>
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M18.005 19H6.005c-1.1 0-2-.9-2-2V7c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v10c0 1.1-.9 2-2 2zm-6-6l-6-4v8h12V9l-6 4z" />
                  </svg>
                </div>
                <h3
                  style={{
                ...
                >
                  Masukkan alamat email Anda untuk melakukan konfirmasi
                  verifikasi akun pengaturan sandi.
                </p>
            ...
            {modalStep === 2 && (
              <form onSubmit={handleResetPasswordSubmit}>
                ...
                >
                  Please create new password, don't use your old password.
                </p>
